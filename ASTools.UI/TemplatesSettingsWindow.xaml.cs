...
namespace ASTools.UI
{
    ...
    public partial class TemplatesSettingsWindow : MetroWindow
    {
        ...
        private void LoadRepositoriesList()
        {
            ...
            // Send command
            _thisApp.ASToolsInputInterface.WriteLine("templates --ui --repo-list");
        ...
        private void RemoveButton_Click(object sender, RoutedEventArgs e)
        {
            if (repositoriesListGrid.SelectedItem != null)
            {
                ...
                if (selectedRow is RepositoryDataModel dataItem)
                {
                    ...
                    // Send command
                    _thisApp.ASToolsInputInterface.WriteLine($"templates --ui --repo-remove {dataItem.Path}");
        ...
        private void NewButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            // Send command
            _thisApp.ASToolsInputInterface.WriteLine($"templates --ui --repo-add {selectedRepositoryPath.Text}");
